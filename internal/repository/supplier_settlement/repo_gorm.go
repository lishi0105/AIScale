...
func (r *supplierSettlementRepo) ListSupplierSettlements(ctx context.Context, params ListParams) ([]domain.SupplierSettlement, int64, error) {
	...
	if params.SupplierID != nil && *params.SupplierID != "" {
...
func (r *supplierSettlementRepo) BatchCreateSupplierSettlements(ctx context.Context, items []domain.SupplierSettlement) error {
	if len(items) == 0 {
		return nil
	}
