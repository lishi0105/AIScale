...
type MarketInquiryRepository interface {
	...
	BatchCreateMarketInquiries(ctx context.Context, inquiries []domain.MarketInquiry) error
	GetByItemAndMarket(ctx context.Context, itemID, marketName string) (*domain.MarketInquiry, error)
}
