...
type DictRepo interface {
	...
	UpdateUnit(ctx context.Context, id string, name string, sort int) error
	...
	UpdateSpec(ctx context.Context, id string, name string, sort int) error
	...
	UpdateMealTime(ctx context.Context, id string, name string, sort int) error
